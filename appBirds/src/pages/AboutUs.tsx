      ...
      <div className="relative isolate overflow-hidden bg-white py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            Our mission is to inspire curiosity, promote conservation, and connect people through 
            the wonder of birdwatching. 
            <br/>
            We believe that protecting bird species and their habitats is a shared 
            responsibility. 
            <br/>
            <strong>Join us </strong>as we celebrate the beauty of birds and work together to ensure their survival 
            ...
            <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
              {stats.map((stat) => (
                <div key={stat.name} className="flex flex-col-reverse gap-1">
                  ...
                  <dd className="text-4xl font-semibold tracking-tight text-gray-200">{stat.value}</dd>
                </div>
              ))}
            </dl>
          </div>
